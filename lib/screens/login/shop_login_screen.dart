...
import 'package:new_flutter_shop_app/block/block_observer.dart';
        ...
        listener: (context, state) {
          if (state is ShopLoginSuccessState) {
            if (state.loginModel.status == true) {
              ...
              displaySuccessToast(state.loginModel);
              ...
              displayErrorToast(state.loginModel);
            }
          }
          MyBlocObserver observer = MyBlocObserver();
          observer.all();
